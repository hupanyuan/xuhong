...
<html>
  ...
  <body>
	...
	<!-- 编辑窗口 -->
	<div id="win" class="easyui-window" title="My Window" style="width:300px;height:400px"   
        data-options="modal:true,closed:true,draggable:true">   
	    <form id="editForm" method="post">
	    	<%--提供id隐藏域 --%>
	    	<input type="hidden" name="id">
		  	客户姓名：<input id="name" type="text" name="name" class="easyui-validatebox" data-options="required:true" onblur="isChinese();"/>
  	...
  	<script type="text/javascript">
  		...
  		function isChecked(){
  			...
  			if(checkedFlg){$("#genderMessage").text("");}else{$("#genderMessage").text("请选择性别！");}
  			return checkedFlg;
  		}
  	</script>
